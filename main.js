...
const cards = [
  ...
  },
  {
    ...
    description: 'This is a web mobile friendly app. In this App, a user can create his own account on the app and after logging in she/he will be able to add categories and then add transactions under those categories.',
...
const popupCards = [
  ...
  },
  {
    ...
    skills: ['html', 'Ruby on rails', 'css', 'GitHub'],
    image: 'images/budget-app.png',
    liveLink: 'https://my-budget-c4p6.onrender.com/',
    sourceLink: 'https://github.com/SelmaNdapanda/budget-app.git',
  },
  {
    title: 'Facebook 360',
    datas: {
